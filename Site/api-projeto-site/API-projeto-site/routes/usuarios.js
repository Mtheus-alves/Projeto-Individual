...
router.post('/autenticar', function(req, res, next) {
	...
	var login_backend = req.body.usuario; // depois de .body, use o nome (name) do campo em seu formulário de login
	var senha = req.body.senha; // depois de .body, use o nome (name) do campo em seu formulário de login	
	
	let instrucaoSql = `select * from cadastro where NomeUsuario='${login_backend}' and Senha='${senha}'`;
...
router.post('/cadastrar', function(req, res, next) {
	...
	Usuario.create({
		...
		login_backend : req.body.usuario,
...
router.get('/sessao/:login', function(req, res, next) {
	let login_backend = req.params.usuario;
